...
public class PriceListItemTests : TestBase
{
    ...
    public void DeactivatePriceListItem_WhenItemNotActive_ThenDeactivationIgnored()
    {
        ...
        // Assert
        var priceListItemActivatedEvents =
            AssertPublishedDomainEvents<PriceListItemDeactivatedDomainEvent>(priceListItem);
    ...
    public void ChangePriceListItem_IsSuccessful()
    {
        ...
        // Assert
        var priceListItemAttributesChangedEvent =
            AssertPublishedDomainEvent<PriceListItemAttributesChangedDomainEvent>(priceListItem);
