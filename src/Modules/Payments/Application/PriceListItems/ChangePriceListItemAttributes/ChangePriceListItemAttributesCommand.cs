...
{
    public ChangePriceListItemAttributesCommand(Guid priceListItemId, string countryCode, string subscriptionPeriodCode,
        string categoryCode, decimal priceValue, string priceCurrency)
    {
