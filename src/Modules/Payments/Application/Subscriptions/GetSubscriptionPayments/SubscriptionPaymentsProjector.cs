...
internal class SubscriptionPaymentsProjector : ProjectorBase, IProjector
{
    ...
    {
        var period = SubscriptionPeriod.GetName(subscriptionPaymentCreated.SubscriptionPeriodCode);
    ...
    {
        var period = SubscriptionPeriod.GetName(subscriptionRenewalPaymentCreated.SubscriptionPeriodCode);
