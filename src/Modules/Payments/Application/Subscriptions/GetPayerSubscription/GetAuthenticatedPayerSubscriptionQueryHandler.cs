...
internal class
    GetAuthenticatedPayerSubscriptionQueryHandler : IQueryHandler<GetAuthenticatedPayerSubscriptionQuery,
        SubscriptionDetailsDto>
{
    ...
    public async Task<SubscriptionDetailsDto> Handle(GetAuthenticatedPayerSubscriptionQuery query,
