...
internal class
    SendSubscriptionCreationConfirmationEmailCommandHandler : ICommandHandler<
        SendSubscriptionCreationConfirmationEmailCommand>
{
    ...
    public Task<Unit> Handle(SendSubscriptionCreationConfirmationEmailCommand request,
