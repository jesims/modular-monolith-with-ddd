...
internal class
    EnableMeetingCommentingConfigurationCommandHandler : ICommandHandler<EnableMeetingCommentingConfigurationCommand>
{
    ...
    public async Task<Unit> Handle(EnableMeetingCommentingConfigurationCommand command,
        CancellationToken cancellationToken)
    {
        var meetingCommentingConfiguration =
            await _meetingCommentingConfigurationRepository.GetByMeetingIdAsync(new MeetingId(command.MeetingId));
