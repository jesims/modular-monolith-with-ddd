...
internal class AddMeetingCommentLikeCommandHandler : ICommandHandler<AddMeetingCommentLikeCommand>
{
    ...
    {
        var meetingComment =
            await _meetingCommentRepository.GetByIdAsync(new MeetingCommentId(request.MeetingCommentId));
        ...
        var likerMeetingGroupMemberData =
            await MembersQueryHelper.GetMeetingGroupMember(_memberContext.MemberId, meetingComment.GetMeetingId(),
                connection);
        ...
        var like = meetingComment.Like(_memberContext.MemberId, likerMeetingGroupMemberData,
