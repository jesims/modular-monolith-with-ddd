...
internal class RemoveMeetingCommentCommandHandler : ICommandHandler<RemoveMeetingCommentCommand>
{
    ...
    internal RemoveMeetingCommentCommandHandler(IMeetingCommentRepository meetingCommentRepository,
    ...
    {
        var meetingComment =
            await _meetingCommentRepository.GetByIdAsync(new MeetingCommentId(command.MeetingCommentId));
