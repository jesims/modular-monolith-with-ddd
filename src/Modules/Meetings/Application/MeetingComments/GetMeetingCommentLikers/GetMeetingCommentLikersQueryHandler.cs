...
internal class
    GetMeetingCommentLikersQueryHandler : IQueryHandler<GetMeetingCommentLikersQuery, List<MeetingCommentLikerDto>>
{
    ...
    public async Task<List<MeetingCommentLikerDto>> Handle(GetMeetingCommentLikersQuery query,
        CancellationToken cancellationToken)
    {
        ...
        var meetingCommentLikers =
            await connection.QueryAsync<MeetingCommentLikerDto>(sql, new { query.MeetingCommentId });
