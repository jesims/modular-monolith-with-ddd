...
internal class
    GetAuthenticatedMemberMeetingsQueryHandler : IQueryHandler<GetAuthenticatedMemberMeetingsQuery,
        List<MemberMeetingDto>>
{
    ...
    public async Task<List<MemberMeetingDto>> Handle(GetAuthenticatedMemberMeetingsQuery request,
