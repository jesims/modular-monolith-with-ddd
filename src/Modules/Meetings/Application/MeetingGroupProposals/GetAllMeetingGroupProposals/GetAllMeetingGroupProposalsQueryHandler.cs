...
internal class
    GetAllMeetingGroupProposalsQueryHandler : IQueryHandler<GetAllMeetingGroupProposalsQuery,
        List<MeetingGroupProposalDto>>
{
    ...
    public async Task<List<MeetingGroupProposalDto>> Handle(GetAllMeetingGroupProposalsQuery query,
