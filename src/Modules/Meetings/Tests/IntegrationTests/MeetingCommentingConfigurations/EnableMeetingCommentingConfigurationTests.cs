...
using CompanyName.MyMeetings.Modules.Meetings.Application.MeetingCommentingConfiguration.
...
public class EnableMeetingCommentingConfigurationTests : TestBase
{
    ...
    public async Task EnableMeetingCommenting_WhenDataIsValid_IsSuccess()
    {
        ...
        // Assert
        var meetingConfiguration =
            await MeetingsModule.ExecuteQueryAsync(new GetMeetingCommentingConfigurationQuery(meetingId));
