...
public class AddReplyToMeetingCommentTests : TestBase
{
    ...
    public async Task AddReply_WhenDataIsValid_IsSuccessful()
    {
        ...
        var meetingCommentId =
            await MeetingsModule.ExecuteCommandAsync(new AddMeetingCommentCommand(meetingId, "The meeting was great."));
        ...
        // Act
        var replyId =
            await MeetingsModule.ExecuteCommandAsync(new AddReplyToMeetingCommentCommand(meetingCommentId, reply));
