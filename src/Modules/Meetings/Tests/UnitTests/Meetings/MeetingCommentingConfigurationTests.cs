...
public class MeetingCommentingConfigurationTests : MeetingTestsBase
{
    ...
    public void CreateMeetingCommentingConfiguration_IsSuccessful()
    {
        ...
        // Assert
        var meetingCommentingConfigurationCreatedEvent =
            AssertPublishedDomainEvent<MeetingCommentingConfigurationCreatedDomainEvent>(
    ...
    public void DisableCommenting_IsSuccessfull()
    {
        ...
        // Assert
        var meetingCommentingDisabledEvent =
            AssertPublishedDomainEvent<MeetingCommentingDisabledDomainEvent>(meetingCommentingConfiguration);
        Assert.That(meetingCommentingDisabledEvent.MeetingId, Is.EqualTo(meeting.Meeting.Id));
    }

    [Test]
    public void
        DisableCommenting_WhenMemberIsNotGroupOrginizer_BreakMeetingCommentingCanBeDisabledOnlyByGroupOrganizerRule()
    {
        // Arrange
        var meeting = CreateMeetingTestData(new MeetingTestDataOptions());
        var meetingCommentingConfiguration = meeting.Meeting.CreateCommentingConfiguration();
    ...
    public void EnableCommenting_IsSuccessfull()
    {
        ...
        // Assert
        var meetingCommentingEnabledEvent =
            AssertPublishedDomainEvent<MeetingCommentingEnabledDomainEvent>(meetingCommentingConfiguration);
        Assert.That(meetingCommentingEnabledEvent.MeetingId, Is.EqualTo(meeting.Meeting.Id));
    }

    [Test]
    public void
        EnableCommenting_WhenMemberIsNotGroupOrginizer_BreakMeetingCommentingCanBeEnabledOnlyByGroupOrganizerRule()
    {
        // Arrange
        var organizerId = new MemberId(Guid.NewGuid());
        var meeting = CreateMeetingTestData(new MeetingTestDataOptions { CreatorId = organizerId });
