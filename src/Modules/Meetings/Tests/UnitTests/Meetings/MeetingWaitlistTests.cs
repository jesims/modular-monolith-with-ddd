...
public class MeetingWaitlistTests : MeetingTestsBase
{
    ...
    public void SignUpMemberToWaitList_WhenMemberIsNotAMemberOfMeetingGroup_IsNotPossible()
    {
        ...
        {
            meetingTestData.Meeting.SignUpMemberToWaitlist(meetingTestData.MeetingGroup,
    ...
    public void SignUpMemberToWaitList_WhenAllConditionsAreSatisfied_IsSuccessful()
    {
        ...
        var meetingWaitlistMemberAdded =
            AssertPublishedDomainEvent<MeetingWaitlistMemberAddedDomainEvent>(meetingTestData.Meeting);
    ...
    public void SignOffMemberFromWaitList_WhenMemberIsOnWaitList_IsSuccessful()
    {
        ...
        var memberSignedOffFromMeetingWaitlist =
            AssertPublishedDomainEvent<MemberSignedOffFromMeetingWaitlistDomainEvent>(meetingTestData.Meeting);
