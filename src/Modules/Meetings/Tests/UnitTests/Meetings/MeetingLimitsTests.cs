...
public class MeetingLimitsTests : MeetingTestsBase
{
    ...
    [Test]
    public void
        CreateMeetingLimits_WhenAttendeesLimitIsLessThanGuestsLimit_BreaksMeetingAttendeesLimitMustBeGreaterThanGuestsLimitRule()
    {
        AssertBrokenRule<MeetingAttendeesLimitMustBeGreaterThanGuestsLimitRule>(() => { MeetingLimits.Create(5, 8); });
    }
    ...
    {
        AssertBrokenRule<MeetingAttendeesLimitCannotBeNegativeRule>(() => { MeetingLimits.Create(-2, 8); });
    }

    [Test]
    public void CreateMeetingLimits_WhenGuestsLimitIsNegative_BreaksMeetingGuestsLimitCannotBeNegativeRule()
    {
        AssertBrokenRule<MeetingGuestsLimitCannotBeNegativeRule>(() => { MeetingLimits.Create(20, -9); });
    }
}
