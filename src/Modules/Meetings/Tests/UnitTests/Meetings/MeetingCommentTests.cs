...
public class MeetingCommentTests : MeetingTestsBase
{
    ...
    public void AddComment_WhenDataIsValid_IsSuccessful()
    {
        ...
        // Act
        var meetingComment = meetingTestData.Meeting.AddComment(commentAuthorId, comment, meetingTestData.MeetingGroup,
    ...
    public void AddComment_WhenAuthorIsNotMeetingGroupMember_BreaksCommentCanBeAddedOnlyByMeetingGroupMemberRule()
    {
        ...
        {
            // Act
            meetingTestData.Meeting.AddComment(new MemberId(Guid.NewGuid()), "Bad meeting!",
                meetingTestData.MeetingGroup, meetingTestData.MeetingCommentingConfiguration);
        });
    }
    ...
    public void AddComment_WhenTextIsEmpty_BreaksCommentTextMustBeProvidedRule(string missingComment)
    {
        ...
        {
            // Act
            meetingTestData.Meeting.AddComment(commentAuthorId, missingComment, meetingTestData.MeetingGroup,
                meetingTestData.MeetingCommentingConfiguration);
        });
    }
    ...
    [Test]
    public void
        AddComment_WhenMeetingCommentingDisabled_BreaksCommentCanBeCreatedOnlyIfCommentingForMeetingEnabledRule()
    {
        // Arrange
        var commentAuthorId = new MemberId(Guid.NewGuid());
        ...
        {
            // Act
            meetingTestData.Meeting.AddComment(commentAuthorId, "I appreciate your work!", meetingTestData.MeetingGroup,
                meetingTestData.MeetingCommentingConfiguration);
        });
    }
    ...
    [Test]
    public void
        EditComment_WhenMeetingCommentingDisabled_BreaksCommentCanBeEditedOnlyIfCommentingForMeetingEnabledRule()
    {
        // Arrange
        ...
        var meetingComment = meetingTestData.Meeting.AddComment(commentAuthorId, "It was good.",
            meetingTestData.MeetingGroup, meetingTestData.MeetingCommentingConfiguration);
        meetingTestData.MeetingCommentingConfiguration.DisableCommenting(groupOrganizerId,
    ...
    public void RemoveComment_IsSuccessful()
    {
        ...
        var meetingComment = meetingTestData.Meeting.AddComment(removingMemberId, "Great meeting!",
            meetingTestData.MeetingGroup, meetingTestData.MeetingCommentingConfiguration);
        meetingComment.ClearDomainEvents();
    ...
    public void RemoveComment_ByNoAuthorNoOrganizer_BreaksMeetingCommentCanBeRemovedOnlyByAuthorOrGroupOrganizerRule()
    {
        ...
        {
            // Act
            meetingComment.Remove(new MemberId(Guid.NewGuid()), meetingTestData.MeetingGroup);
        });
    }
    ...
    public void AddReplyToComment_WhenDataIsValid_IsSuccessful()
    {
        ...
        // Act
        var replyToComment = meetingComment.Reply(replyAuthorId, reply, meetingTestData.MeetingGroup,
            meetingTestData.MeetingCommentingConfiguration);

        // Assert
        var replyToMeetingCommentAddedEvent =
            AssertPublishedDomainEvent<ReplyToMeetingCommentAddedDomainEvent>(replyToComment);
    ...
    [Test]
    public void
        AddReplyToComment_WhenAuthorIsNotMeetingGroupMember_BreaksCommentCanBeAddedOnlyByMeetingGroupMemberRule()
    {
        // Arrange
        var commentAuthorId = new MemberId(Guid.NewGuid());
        var meetingTestData =
        ...
        {
            // Act
            meetingComment.Reply(new MemberId(Guid.NewGuid()), "Exactly!", meetingTestData.MeetingGroup,
                meetingTestData.MeetingCommentingConfiguration);
        });
    }
    ...
    public void AddReplyToComment_WhenTextIsEmpty_BreaksCommentTextMustBeProvidedRule(string missingReply)
    {
        ...
        {
            // Act
            meetingComment.Reply(replyAuthorId, missingReply, meetingTestData.MeetingGroup,
                meetingTestData.MeetingCommentingConfiguration);
        });
    }
    ...
    [Test]
    public void
        AddReplyToComment_WhenMeetingCommentingDisabled_BreaksCommentCanBeCreatedOnlyIfCommentingForMeetingEnabledRule()
    {
        // Arrange
        ...
        var meetingTestData = CreateMeetingTestData(new MeetingTestDataOptions
            { CreatorId = creatorId, Attendees = new[] { commentAuthorId, replyAuthorId } });
        ...
        {
            // Act
            meetingComment.Reply(replyAuthorId, "Exactly!", meetingTestData.MeetingGroup,
                meetingTestData.MeetingCommentingConfiguration);
        });
    }
    ...
    public void AddLikeToComment_WhenDataIsValid_IsSuccessful()
    {
        ...
        var meetingTestData = CreateMeetingTestData(new MeetingTestDataOptions
            { Attendees = new[] { commentAuthorId, likerId } });
        ...
        var like = meetingComment.Like(
            likerId,
            new MeetingGroupMemberData(meetingTestData.MeetingGroup.Id, likerId),
            0);
    ...
    [Test]
    public void
        AddLikeToComment_WhenTheCommentIsAlreadyLikedByTheMember_BreaksCommentCannotBeLikedByTheSameMemberMoreThanOnceRule()
    {
        // Arrange
        var commentAuthorId = new MemberId(Guid.NewGuid());
        var likerId = new MemberId(Guid.NewGuid());
