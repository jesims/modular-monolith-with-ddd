...
public class MeetingTests : MeetingTestsBase
{
    ...
    public void CancelMeeting_WhenMeetingHasStarted_IsNotPossible()
    {
        ...
        AssertBrokenRule<MeetingCannotBeChangedAfterStartRule>(() => { meetingTestData.Meeting.Cancel(creatorId); });
    }
    ...
    public void RemoveAttendee_WhenMemberIsAttendee_AndReasonIsProvided_IsSuccessful()
    {
        ...
        var meetingAttendeeRemoved =
            AssertPublishedDomainEvent<MeetingAttendeeRemovedDomainEvent>(meetingTestData.Meeting);
    ...
    [Test]
    public void
        RemoveAttendee_WhenMemberIsAttendee_AndReasonIsNotProvided_BreaksReasonOfRemovingAttendeeFromMeetingMustBeProvidedRule()
    {
        var creatorId = new MemberId(Guid.NewGuid());
        var meetingTestData = CreateMeetingTestData(new MeetingTestDataOptions
        {
