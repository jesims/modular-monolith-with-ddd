...
public class MeetingGroupProposalTests : TestBase
{
    ...
    {
        var proposalId = await AdministrationModule.ExecuteCommandAsync(
        ...
        var meetingGroupProposal =
            await AdministrationModule.ExecuteQueryAsync(new GetMeetingGroupProposalQuery(proposalId));
        ...
        Assert.That(meetingGroupProposal.LocationCountryCode,
            Is.EqualTo(MeetingGroupProposalSampleData.LocationCountryCode));
    ...
    [Test]
    public async Task
        AcceptMeetingGroupProposal_WhenProposalIsAlreadyAccepted_BreaksMeetingGroupProposalCanBeVerifiedOnceRule()
    {
        var proposalId = await AdministrationModule.ExecuteCommandAsync(
            new RequestMeetingGroupProposalVerificationCommand(
                MeetingGroupProposalSampleData.MeetingGroupProposalId,
