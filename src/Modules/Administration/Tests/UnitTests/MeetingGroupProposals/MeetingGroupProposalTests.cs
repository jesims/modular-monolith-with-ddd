...
public class MeetingGroupProposalTests : TestBase
{
    ...
    public void CreateProposalToVerify_IsSuccessful()
    {
        ...
        var meetingGroupProposalVerificationRequested =
            AssertPublishedDomainEvent<MeetingGroupProposalVerificationRequestedDomainEvent>(meetingGroupProposal);
        Assert.That(meetingGroupProposalVerificationRequested.MeetingGroupProposalId,
            Is.EqualTo(new MeetingGroupProposalId(meetingGroupProposalId)));
    }
    ...
    public void AcceptProposal_WhenDecisionIsNotMade_IsSuccessful()
    {
        ...
        var meetingGroupProposalAccepted =
            AssertPublishedDomainEvent<MeetingGroupProposalAcceptedDomainEvent>(meetingGroupProposal);

        Assert.That(meetingGroupProposalAccepted.MeetingGroupProposalId,
            Is.EqualTo(new MeetingGroupProposalId(meetingGroupProposalId)));
    }
    ...
    public void AcceptProposal_WhenDecisionIsMade_CanBeVerifiedOnlyOnce()
    {
        ...
        AssertBrokenRule<MeetingGroupProposalCanBeVerifiedOnceRule>(() => { meetingGroupProposal.Accept(userId); });
    }
